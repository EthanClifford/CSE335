...
private:
    ...
    void AddGarden(const std::wstring& file);
    ...
    bool mPruneChecked = false;     ///< True if the Prune menu option is checked, false otherwise
    bool mMouseHistoryCheck = false;    ///< True if the Mouse History option is checked, false otherwise
