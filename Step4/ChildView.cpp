...
/**
*  Add a CTileGarden tile to the drawing.
* \param file The file for the garden image
*/
void CChildView::AddGarden(const std::wstring& file)
{
...
/** Menu handler for when the Prune menu option is selected */
void CChildView::OnGardenPrune()
{
    mPruneChecked = !mPruneChecked;
}

/** Adds the check menu functionality to the Prune menu option 
* \param pCmdUI The pointer that handles checking and unchecking the menu option
*/
void CChildView::OnUpdateGardenPrune(CCmdUI* pCmdUI)
{
    
    pCmdUI->SetCheck(mPruneChecked); // Prune is a check menu option
}

/** Menu handler for when the Prune all option is selected 
*
* Calls a visitor to handle pruning all garden tiles
*/
...
/** Menu handler for when we select the Garden menu option */
void CChildView::OnLandscapingGarden()
{
    AddGarden(L"garden.png");
}

/** Adds the check menu functionality to the Mouse History menu option
* \param pCmdUI The pointer that handles checking and unchecking the menu option
*/
void CChildView::OnUpdateViewMousehistory(CCmdUI* pCmdUI)
{
    pCmdUI->SetCheck(mMouseHistoryCheck);
}

/** Menu handler for when the Mouse History menu option is selected */
void CChildView::OnViewMousehistory()
{
    mMouseHistoryCheck = !mMouseHistoryCheck;
}
