 ...
 *
 * \param cs A structure witht he window creation parameters 
 * \returns TRUE
 */
...
/**
 * Called whe the left mouse button is released
 * \param nFlags Flags associated wiht the mouse button release
 * \param point Where the button was released
 */
 ...
 * \param point Where the mouse was moved
 */
void CChildView::OnMouseMove(UINT nFlags, CPoint point)
{
    ...
    if (mGrabbedItem != nullptr)
    {
        // If an item is being moved, we only continue to move
        // it while the left button is down.
...
/**
 * Add Decor/DecorCastle menu option handler
 */
...
/**
 * Add File/SaveAs menu option handler
 */
...
/**
 * This function is called when a File Open menu item is selected.
 *
